...
class FileSpacer:
    ...
    def compress_file(self, 
                     ...
                     calculate_hash: bool = True) -> CompressionStats:
    ...
    def compress_folder(self, 
                       ...
                       parallel: bool = True) -> CompressionStats:
        ...
        try:
            ...
            cctx = zstd.ZstdCompressor(
                ...
                threads=self.config.get('parallel_threads', 1) if parallel else 1
            )
    ...
    def extract_zst(self, 
        ...
        try:
            ...
            with open(input_path, 'rb') as infile:
                # Read and decompress first block to check format
                first_block = infile.read(1024 * 64)  # 64KB
                infile.seek(0)
                
                try:
                    decompressed_sample = dctx.decompress(first_block, max_output_size=1024)
                ...
                if is_tar:
                    ...
                    with dctx.stream_reader(infile) as reader:
                        with tarfile.open(fileobj=reader, mode='r|') as tar:
                            # Count members first if possible
                            members = list(tar)
                            total_members = len(members)
    ...
    def _is_tar_format(self, data: bytes) -> bool:
        ...
        try:
            ...
            if len(data) >= 512:
                ...
                if mode_field and all(c in b'01234567 ' for c in mode_field):
                    return True
        except Exception:
            pass
        return False
